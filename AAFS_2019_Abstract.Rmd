...
Results from these techniques showed early promise when applied to the closed-set study of the Hamby Set 44 [@Hamby] bullets. The pre-processing methods are evaluated at different levels: in a first step we compare results from the techniques to manually identified groove locations. A second, and maybe more important, step is to assess the performance of a method in regards to the prediction accuracy of the automated matching algorithm as described in @Hare1.
