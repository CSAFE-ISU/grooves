...
get_and_plot_grooves <- function(dataset, bullet_num){
  ...
  p1 <- bullet %>% ggplot() + geom_point(aes(x = x, y = value_std)) + geom_vline(xintercept = grooves[1], colour = "blue") + geom_vline(xintercept = grooves[2], colour = "blue") + theme_bw() + geom_line(aes(x = x, y = rlo_pred), colour = "green")
  p2 <- bullet %>% ggplot() + geom_point(aes(x = x, y = rlo_resid)) + geom_vline(xintercept = grooves[1], colour = "blue") + geom_vline(xintercept = grooves[2], colour = "blue") + theme_bw() + geom_hline(yintercept = 0, colour = "green")
