...
phoenix_eval <- readRDS("../data/phoenix/phoenix_paper.rda")
phoenix_eval$grooves_kr1 <- grooves_kr1
```


```{r define-left-and-right-groove, echo = F, warning = F, message = F}

phoenix_eval$left_groove_kr1 <- 0
phoenix_eval$right_groove_kr1 <- 0
for (i in 1:nrow(phoenix_eval)){
  phoenix_eval$left_groove_kr1[i] <- phoenix_eval$grooves_kr1[[i]]$groove[1]
  phoenix_eval$right_groove_kr1[i] <- phoenix_eval$grooves_kr1[[i]]$groove[2]
}

saveRDS(phoenix_eval, "../data/phoenix/phoenix_paper.rda")
