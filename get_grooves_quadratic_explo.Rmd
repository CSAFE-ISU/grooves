...
hamby44 %>% ggplot() + geom_point(aes(x = left_groove, y = left_resid_sum, colour = factor(is_left_groove)))

hamby44 %>% ggplot() + geom_point(aes(x = right_resid_sum, y = right_groove, colour = factor(is_right_groove)))
```
